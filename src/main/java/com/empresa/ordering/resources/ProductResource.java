...
import com.empresa.ordering.services.ProductService;
...
public class ProductResource {
	...
	@GetMapping(value = "/{id}")
	public ResponseEntity<Product> findById(@PathVariable Long id) { /*PathVariable aponta para o Spring aceitar a id que sera passada como argumento*/
